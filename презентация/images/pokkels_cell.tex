...
\begin{tikzpicture}
    ...
    \node [draw, shape=rectangle, fill=white, minimum width=0.25cm, minimum height=1cm, anchor=center] at (3,0.5) (res2) {};
    ...
    \node [draw, shape=rectangle, fill=white, minimum width=0.6cm, minimum height=0.6cm, anchor=center] at (pokplace) (pok) {cell};
