...
\begin{tikzpicture}
 ...
 %    }
    ...
    \draw [interface] (0,4) node [left] {$E_3$} rectangle ++(3,00);
    \draw [thick] (0,4) -- ++(3,0);

    \draw [very thick, ->, gray] (0.5,0) -- node [below, pos=0.3,sloped, black]{накачка} ++(0,4);
    \draw [line width=1pt, ->] (2,2.5)  --  node [below, rotate=180, pos=0.5,sloped]{генерация} (2,0);
